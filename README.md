...
This is the thin-client v0.1.24 marketplace for Claude Code and Codex. Create a PAT on Gluxer’s **Connect coding agent** page and use the endpoint shown there as `GLUXER_MCP_URL`.
