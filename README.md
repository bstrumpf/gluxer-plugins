...
This is the thin-client v0.1.39 marketplace for Claude Code and Codex. Create a PAT on Gluxer’s **Connect coding agent** page. Both packages connect to `https://mcp.gluxer.com/api/mcp`.
