...
<!-- behavior-version: 0.1.0; host: codex -->
...
Use Codex plans, repository edits, terminal verification, browser QA, and optional delegation only after the applicable Gluxer gate permits them.
